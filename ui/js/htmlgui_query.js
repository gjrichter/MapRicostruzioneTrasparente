...
ixmaps.searchMap = function(){
	...
	output.innerHTML = "please wait ... <img src='./resources/icons/magnifying-glass.gif' width='16' height='16' ALT='loading...' />";
...
ixmaps.displaySearchMapResult = function(startIndex,szMode){
	...
	if ( foundNodes.length > 0 ){
		szOutput += " <a class='link' onclick='javascript:ixmaps.gotoSearchMapResult(-1,\"show\")'><img src='./resources/icons/highlight_big.gif' width='14' height='14' alt='highlight items'  title='highlight items' border='0'/><\/a>";
		szOutput += " <a class='link' onclick='javascript:ixmaps.gotoSearchMapResult(-1,\"zoomto\")'><img src='./resources/icons/magnifying-glass.gif' width='14' height='14' alt='zoom to items' title='zoom to items' border='0'/><\/a>";
		szOutput += " <a class='link' onclick='javascript:ixmaps.gotoSearchMapResult(-1,\"info\")'><img src='./resources/icons/bubble_2.gif' width='14' height='14' alt='show info of items' title='show info of items' border='0'/><\/a>";
		szOutput += " <a class='link' onclick='javascript:ixmaps.gotoSearchMapResult(-1,\"select\")'><img src='./resources/icons/select.gif' width='14' height='14' alt='select items' title='select items' border='0'/><\/a>";
	}
	output.innerHTML = szOutput;
	...
	if( fSearchMode == 'advanced' || fDisplayMode == 'advanced' || fDisplayMode == 'fields' || foundNodes[0].feature  == '*' ){
		...
		for ( var i=startIndex; i<Math.min(foundNodes.length,startIndex+maxRows); i++ ){
			...
			szOutput += "<a class='link' href='javascript:ixmaps.gotoSearchMapResult("+i+",\"zoomto\",30)'><img src='./resources/icons/magnifying-glass.gif' width='14' height='14' ALT='zoom to item' border='0'/><\/a>";
			szOutput += "<\/td>";
			for ( var n=nStart; n<nEnd; n++ ){
				szOutput += "<td nowrap>";
			...
			if ( fAllFields ){
				szOutput += "<td nowrap>";
				szOutput += "<a class='link' href='javascript:ixmaps.gotoSearchMapResult("+i+",1,30)'><img src='./resources/icons/magnifying-glass.gif' width='14' height='14' ALT='zoom to item' border='0'/><\/a>";
				szOutput += "<\/td>";
			}
			szOutput += "<\/tr>";
		}
